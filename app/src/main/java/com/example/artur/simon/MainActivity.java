package com.example.artur.simon;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verde = (Button) findViewById(R.id.green);
        rojo = (Button) findViewById(R.id.red);
        amarillo = (Button) findViewById(R.id.yellow);
        azul = (Button) findViewById(R.id.blue);
        comprobar = (Button) findViewById(R.id.start);
        botoncolores = (Button) findViewById(R.id.central);
    ...
    public void nuevaPartida() {
        ...
        findViewById(R.id.central).setBackgroundColor(Color.GRAY);
        turnosTotales = 0;
    ...
    public void actualizacolor(int color) {
        View fondo = findViewById(R.id.central);
    ...
    public void mostrarSecuencia() {
        final View fondo = findViewById(R.id.central);
        posicionSecuencia = 0;
    ...
    public void comprobarColor(int color) {
        Button botonStart = (Button) findViewById(R.id.start);
        final Button perder = (Button) findViewById(R.id.central);
